        ...
        <div class="admin-container">
            ...
            <main class="admin-content">
                <section class="content-header">
                    <h1>Order Processing Queue (15 Total)</h1>
                    <button class="cta-button" style="padding: 0.6rem 1.2rem; font-size: 0.9rem;">View Invoice History</button>
                </section>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Anna Smith</td>
                                <td>3 min ago</td>
                                <td style="font-weight: bold;">$129.00</td>
                                <td><span class="badge badge-success">New</span></td>
                                <td>
                                    <button class="cta-button" style="padding: 0.3rem 0.6rem; font-size: 0.8rem;">Process</button>
                            ...
                            <tr>
                                ...
                                <td>Sara Lee</td>
                                <td>1 hour ago</td>
                                <td style="font-weight: bold;">$289.00</td>
                                <td><span class="badge badge-warning">Processing</span></td>
                                <td>
                                    <button class="btn-secondary" style="padding: 0.3rem 0.6rem;">Ship</button>
                                    <button class="btn-secondary" style="padding: 0.3rem 0.6rem;">View</button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <button class="btn-secondary" style="padding: 0.3rem 0.6rem;">Track</button>
                                    <button class="btn-secondary" style="padding: 0.3rem 0.6rem;">View</button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>Lia Wong</td>
                                <td>3 days ago</td>
                                <td style="font-weight: bold;">$199.00</td>
                                <td><span class="badge badge-danger">Cancelled</span></td>
                                <td>
                                    <button class="btn-secondary" style="padding: 0.3rem 0.6rem;">Refund</button>
                                    <button class="btn-secondary" style="padding: 0.3rem 0.6rem;">View</button>
                                </td>
                            </tr>
                        </tbody>
